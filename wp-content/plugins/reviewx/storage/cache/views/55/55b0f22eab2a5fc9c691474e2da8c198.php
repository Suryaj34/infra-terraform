...
/* storefront/widget/Features/ReviewForm/index.twig */
class __TwigTemplate_983fe464d7d20e8a3bfbafca5aaedb7e extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"rvx-review-form__wrapper\"
    ...
    <form class=\"rvx-mb-0 rvx-review-form\" @submit.prevent=\"reviewSubmitHandler()\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 81
            yield "                                    <svg @click=\"selectCriteriaStars(";
            yield $this->env->getRuntime('Rvx\Twig\Runtime\EscaperRuntime')->escape($context["i"], "html", null, true);
            yield ")\" class=\"rvx-cursor-pointer\"
                                        width=\"24px\" height=\"24px\" viewBox=\"0 0 24 24\"
                                        xmlns=\"http://www.w3.org/2000/svg\" enable-background=\"new 0 0 24 24\">
                                        <path
                                            :class=\"getCriteriaStarsClass(";
            // line 85
            yield $this->env->getRuntime('Rvx\Twig\Runtime\EscaperRuntime')->escape($context["i"], "html", null, true);
            yield ")\"
                ...
                <div class=\"rvx-grid rvx-grid-cols-6 rvx-gap-[26px] rvx-review-form__attachment\">
                    ...
                    <div class=\"rvx-col-span-4\">
                        <div class=\"rvx-review-form__attachment--inner\">
                            ";
        // line 193
        yield from         $this->loadTemplate("storefront/widget/Features/ReviewForm/MediaUpload.twig", "storefront/widget/Features/ReviewForm/index.twig", 193)->unwrap()->yield($context);
        // line 194
        yield "                        </div>
                    </div>
                </div>
            ...
            <div class=\"rvx-grid rvx-grid-cols-6 rvx-gap-[26px] rvx-review-form__recommended\"
                ...
                <div x-show=\"reviewSettingsData?.data.setting?.review_settings.reviews.allow_recommendations\"
                    ...
                    <div class=\"rvx-flex rvx-items-center rvx-gap-space5\">
                        ...
                        <label for=\"recommended-yes\" class=\"rvx-m-0 !rvx-font-nunito\">";
        // line 210
        yield $this->env->getRuntime('Rvx\Twig\Runtime\EscaperRuntime')->escape($this->env->getFunction('__')->getCallable()("Yes", "reviewx"), "html", null, true);
        yield "</label>
                    </div>
                    <div class=\"rvx-flex rvx-items-center rvx-gap-space5\">
                        <input x-model=\"newReview.is_recommended\" id=\"recommended-no\" value=\"false\" type=\"radio\">
                        <label for=\"recommended-no\" class=\"rvx-m-0 !rvx-font-nunito\">";
        // line 214
        yield $this->env->getRuntime('Rvx\Twig\Runtime\EscaperRuntime')->escape($this->env->getFunction('__')->getCallable()("No", "reviewx"), "html", null, true);
        yield "</label>
                    </div>
                </div>
            </div>
...
";
        // line 232
        yield "                    <input id=\"consent\" x-model=\"newReview.consent\" type=\"checkbox\" />
            ...
            <div class=\"rvx-review-form__footer rvx-box-border\">
                ...
                <button type=\"submit\" :disabled=\"isReviewSubmitting\"
                    ...
                    ";
        // line 253
        yield $this->env->getRuntime('Rvx\Twig\Runtime\EscaperRuntime')->escape($this->env->getFunction('__')->getCallable()("Submit Review", "reviewx"), "html", null, true);
        yield "
                </button>
            </div>
        </div>
    ...
    {
        return "storefront/widget/Features/ReviewForm/index.twig";
    }
    ...
    {
        return array (  334 => 253,  311 => 232,  291 => 214,  284 => 210,  266 => 194,  264 => 193,  184 => 115,  173 => 110,  166 => 107,  162 => 106,  144 => 90,  133 => 85,  125 => 81,  121 => 80,  40 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "storefront/widget/Features/ReviewForm/index.twig", "/var/www/html/wp-content/plugins/reviewx/resources/views/storefront/widget/Features/ReviewForm/index.twig");
    }
}
