...
/* storefront/widget/Features/Reviews/Modals/ReviewSuccessModal.twig */
class __TwigTemplate_afa40660248da70920fd2a018a09a9a2 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        yield "<!--x-init=\"init()\" @keydown.escape.window=\"close\" @click.away=\"close\"-->
...
<!--                        <span class=\"material-symbols-rounded !rvx-text-[60px] rvx-text-center rvx-w-full\">thumb_up</span>-->
                        <div class=\"rvx-space-y-space16 rvx-w-full rvx-text-center\">
                            <h2 class=\"rvx-text-neutral-700\">
                                 ";
        // line 40
        yield $this->env->getRuntime('Rvx\Twig\Runtime\EscaperRuntime')->escape($this->env->getFunction('__')->getCallable()("Thanks for your review!", "reviewx"), "html", null, true);
        yield "
                            </h2>
                            <p class=\"rvx-text-neutral-700\">";
        // line 42
        yield $this->env->getRuntime('Rvx\Twig\Runtime\EscaperRuntime')->escape($this->env->getFunction('__')->getCallable()("Your feedback helps us improve our service.", "reviewx"), "html", null, true);
        yield "</p>
                        </div>
                    </div>
                </div>
...
";
    ...
    {
        return "storefront/widget/Features/Reviews/Modals/ReviewSuccessModal.twig";
    }
    ...
    {
        return array (  86 => 42,  81 => 40,  40 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "storefront/widget/Features/Reviews/Modals/ReviewSuccessModal.twig", "/var/www/html/wp-content/plugins/reviewx/resources/views/storefront/widget/Features/Reviews/Modals/ReviewSuccessModal.twig");
    }
}
