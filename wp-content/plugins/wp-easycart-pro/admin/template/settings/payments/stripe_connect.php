...
$supported_payment_methods = array(
	'acss_debit_payments' => 'missing',
	'affirm_payments' => 'missing',
	'afterpay_clearpay_payments' => 'missing',
	'au_becs_debit_payments' => 'missing',
	'bacs_debit_payments' => 'missing',
	'bancontact_payments' => 'missing',
	'bank_transfer_payments' => 'missing',
	'blik_payments' => 'missing',
	'boleto_payments' => 'missing',
	'card_payments' => 'missing',
	'cartes_bancaires_payments' => 'missing',
	'eps_payments' => 'missing',
	'fpx_payments' => 'missing',
	'giropay_payments' => 'missing',
	'grabpay_payments' => 'missing',
	'ideal_payments' => 'missing',
	'india_international_payments' => 'missing',
	'jcb_payments' => 'missing',
	'klarna_payments' => 'missing',
	'konbini_payments' => 'missing',
	'link_payments' => 'missing',
	'oxxo_payments' => 'missing',
	'p24_payments' => 'missing',
	'paynow_payments' => 'missing',
	'promptpay_payments' => 'missing',
	'sepa_debit_payments' => 'missing',
	'sofort_payments' => 'missing',
	'us_bank_account_ach_payments' => 'missing',
);
...
if ( class_exists( 'ec_stripe_connect' ) ) {
	...
	if ( $account ) {
		foreach ( $supported_payment_methods as $key => $val ) {
			if ( isset( $supported_payment_methods[ $key ] ) ) {
				$supported_payment_methods[ $key ] = ( isset( $account->capabilities ) && isset( $account->capabilities->{ $key } ) ) ? $account->capabilities->{ $key } : 'missing';
			}
		}
...
<div class="ec_admin_stripe_row">
	<div class="ec_admin_slider_row">
		...
		<h3>
			<?php _e( 'Stripe', 'wp-easycart-pro' ); ?>
			<a href="<?php echo wp_easycart_admin( )->helpsystem->print_docs_url( 'settings', 'payment', 'stripe' );?>" target="_blank" class="ec_help_icon_link" title="<?php _e( 'View Help?', 'wp-easycart-pro' ); ?>" style="float:left; margin-left:0px;">
				<div class="dashicons-before ec_help_icon dashicons-info"></div> <?php _e( 'Help', 'wp-easycart-pro' ); ?>
			</a>
		</h3>
		<div class="ec_admin_slider_row_description" id="wpeasycart-stripe-connect-settings">
			<div style="float:left; width:100%; margin-bottom:15px;">
				<?php _e( 'Stripe offers the ability to pay with a credit card directly on your website. Adding Stripe gives your shopping cart a more professional look and increases conversions.', 'wp-easycart-pro' ); ?>
				<?php if( get_option( 'ec_option_stripe_connect_production_access_token' ) != '' ){ ?>
				<br />
				<a href="https://connect.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=production&wp_easycart_nonce=' . wp_create_nonce( 'wp-easycart-stripe' ) ); ?>&env=production"><?php _e( 'Switch Production Account', 'wp-easycart-pro' ); ?></a>
				<?php }?>
				<?php if( get_option( 'ec_option_stripe_connect_sandbox_access_token' ) != '' ){ ?>
				<br />
				<a href="https://connect.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=sandbox&wp_easycart_nonce=' . wp_create_nonce( 'wp-easycart-stripe' ) ); ?>&env=sandbox"><?php _e( 'Switch Sandbox Account', 'wp-easycart-pro' ); ?></a>
				<?php }?>
			</div>
			...
			<div class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show" style="padding:0px !important;">
				<label style="float:left; width:100%;"><?php _e( 'Currency', 'wp-easycart-pro' ); ?></label>
			...
			<div class="ec_method_deactivated" id="stripe_account_currency_note" data-currency="<?php echo esc_attr( $default_currency ); ?>"<?php if ( ! $default_currency || get_option( 'ec_option_stripe_currency' ) == $default_currency ) { ?> style="display:none"<?php }?>>
			...
			<div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;">
				<label style="float:left; width:100%;"><?php _e( 'Business Country', 'wp-easycart-pro' ); ?></label>
				<select name="ec_option_stripe_company_country" id="ec_option_stripe_company_country" onchange="ec_admin_save_stripe_connect_options( );">
					...
					<option value="PL" <?php if ( get_option( 'ec_option_stripe_company_country' ) == 'PL' ) { echo ' selected'; }; ?>>Poland (PL)</option>
			...
			<div class="ec_method_deactivated" id="stripe_account_country_note" data-country="<?php echo esc_attr( $account_country ); ?>"<?php if ( ! $account_country || get_option( 'ec_option_stripe_company_country' ) == $account_country ) { ?> style="display:none"<?php }?>>
			...
			<div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;">
				<label><?php _e( 'Payment Theme', 'wp-easycart-pro' ); ?></label>
				<select name="ec_option_stripe_payment_theme" id="ec_option_stripe_payment_theme" onchange="ec_admin_save_stripe_connect_options( );">
					<option value="stripe"<?php echo ( 'stripe' == get_option( 'ec_option_stripe_payment_theme' ) ) ? ' selected="selected"' : ''; ?>><?php esc_attr_e( 'Stripe Theme', 'wp-easycart-pro' ); ?></option>
					<option value="night"<?php echo ( 'night' == get_option( 'ec_option_stripe_payment_theme' ) ) ? ' selected="selected"' : ''; ?>><?php esc_attr_e( 'Night Theme', 'wp-easycart-pro' ); ?></option>
					<option value="flat"<?php echo ( 'flat' == get_option( 'ec_option_stripe_payment_theme' ) ) ? ' selected="selected"' : ''; ?>><?php esc_attr_e( 'Flat Theme', 'wp-easycart-pro' ); ?></option>
					<option value="none"<?php echo ( 'none' == get_option( 'ec_option_stripe_payment_theme' ) ) ? ' selected="selected"' : ''; ?>><?php esc_attr_e( 'None', 'wp-easycart-pro' ); ?></option>
				</select>
			</div>
			<div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;">
				<label><?php _e( 'Payment Layout', 'wp-easycart-pro' ); ?></label>
				<select name="ec_option_stripe_payment_layout" id="ec_option_stripe_payment_layout" onchange="ec_admin_save_stripe_connect_options( );">
					<option value="accordion"<?php echo ( 'accordion' == get_option( 'ec_option_stripe_payment_layout' ) ) ? ' selected="selected"' : ''; ?>><?php esc_attr_e( 'Accordion', 'wp-easycart-pro' ); ?></option>
					<option value="tabs"<?php echo ( 'tabs' == get_option( 'ec_option_stripe_payment_layout' ) ) ? ' selected="selected"' : ''; ?>><?php esc_attr_e( 'Tabs', 'wp-easycart-pro' ); ?></option>
				</select>
			</div>
			<div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;">
				<label><?php _e( 'Subscription Notices', 'wp-easycart-pro' ); ?></label>
				<select name="ec_option_stripe_subscription_notices" id="ec_option_stripe_subscription_notices" onchange="ec_admin_save_stripe_connect_options( );">
					<option value="0"<?php echo ( '0' == get_option( 'ec_option_stripe_subscription_notices' ) ) ? ' selected="selected"' : ''; ?>><?php esc_attr_e( 'Disable Upcoming Payment Emails', 'wp-easycart-pro' ); ?></option>
					<option value="1"<?php echo ( '1' == get_option( 'ec_option_stripe_subscription_notices' ) ) ? ' selected="selected"' : ''; ?>><?php esc_attr_e( 'Enable Upcoming Payment Emails', 'wp-easycart-pro' ); ?></option>
				</select>
			</div>
			<?php if ( get_option( 'ec_option_onepage_checkout' ) ) { ?>
				<div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;">
					<label><?php _e( 'Stripe Address Auto-Complete', 'wp-easycart-pro' ); ?></label>
			...
			<div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show wp_easycart_admin_no_padding" style="padding:0px !important;">
				<?php wp_easycart_admin( )->load_toggle_group_text( 'ec_option_stripe_connect_webhook_secret', 'ec_admin_save_stripe_connect_options', get_option( 'ec_option_stripe_connect_webhook_secret' ), __( 'Secure Your Webhook', 'wp-easycart-pro' ), __( 'Enter the signing secret from your webhook to enhance security.', 'wp-easycart-pro' ), '', true ); ?>
			</div>
			...
			<div id="stripe_buy_now_later" class="ec_admin_stripe_section" data-currencies="USD,CAD,GBP,AUD,NZD,EUR,DKK,SEK,NOK" data-countries="US,AU,CA,FR,NZ,ES,GB,AT,BE,DK,EE,FI,GR,DE,GR,IE,IT,LV,LT,NL,NO,SK,SI,SE"<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'USD', 'CAD', 'GBP', 'AUD', 'NZD', 'EUR', 'DKK', 'SEK', 'NOK' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'US', 'AU', 'CA', 'FR', 'NZ', 'ES', 'GB', 'AT', 'BE', 'DK', 'EE', 'FI', 'GR', 'DE', 'GR', 'IE', 'IT', 'LV', 'LT', 'NL', 'NO', 'SK', 'SI', 'SE' ) ) ) { echo ' style="display:none;"'; } ?>>
				<h3 style="float:left; width:100%; margin:25px 0 10px; border-bottom:1px solid #CCC; padding:0 0 5px;"><?php esc_attr_e( 'Buy Now, Pay Later', 'wp-easycart-pro' ); ?></h3>
				<div id="stripe_use_affirm" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="USD" data-countries="US" style="padding:0px !important;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'USD' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'US' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Affirm', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_affirm" id="ec_option_stripe_affirm" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_affirm' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_affirm' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['affirm_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'affirm_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'affirm_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				</div>
				...
				<div id="stripe_use_afterpay" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="USD,CAD,GBP,AUD,NZD,EUR" data-countries="AU,CA,FR,NZ,ES,GB,US" data-country-currency='{"AU": ["AUD"],"CA": ["CAD"],"NZ": ["NZD"],"GB": ["GBP"],"US": ["USD"],"FR": ["EUR"],"ES": ["EUR"]}' style="padding:0px !important;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'USD', 'CAD', 'GBP', 'AUD', 'NZD', 'EUR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'US', 'AU', 'CA', 'FR', 'NZ', 'ES', 'GB' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable AfterPay', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_afterpay" id="ec_option_stripe_afterpay" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_afterpay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_afterpay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['afterpay_clearpay_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'afterpay_clearpay_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'afterpay_clearpay_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
					<div class="ec_status_error" style="padding:5px 15px;<?php if ( isset( $afterpay_rules[ get_option( 'ec_option_stripe_company_country' ) ] ) && in_array( get_option('ec_option_stripe_currency' ), $afterpay_rules[ get_option( 'ec_option_stripe_company_country' ) ] ) ) { ?> display:none<?php }?>"><span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type requires your business country and currency to match local norms.', 'wp-easycart-pro' ); ?></span></div>
				</div>
				...
				<div id="stripe_use_klarna" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="EUR,USD,GBP,DKK,SEK,NOK" data-countries="AT,BE,DK,EE,FI,GR,DE,GR,IE,IT,LV,LT,NL,NO,SK,SI,ES,SE,GB,US" data-country-currency='{"AT": ["EUR"],"BE": ["EUR"],"DK": ["DKK"],"FI": ["EUR"],"FR": ["EUR"],"DE": ["EUR"],"IE": ["EUR"],"IT": ["EUR"],"NL": ["EUR"],"NO": ["NOK"],"ES": ["EUR"],"SE": ["SEK"],"GB": ["GBP"],"US": ["USD"]}' style="padding:0px !important;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR', 'USD', 'GBP', 'DKK', 'SEK', 'NOK' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'US', 'ES', 'GB', 'AT', 'BE', 'DK', 'EE', 'FI', 'GR', 'DE', 'GR', 'IE', 'IT', 'LV', 'LT', 'NL', 'NO', 'SK', 'SI', 'SE' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Klarna', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_klarna" id="ec_option_stripe_klarna" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_klarna' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_klarna' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['klarna_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'klarna_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'klarna_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				...
				<div id="stripe_pay_later_minimum" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show" style="padding:0px;">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Minimum Cart Total (Pay Later Methods)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<input type="number" step="1" min="50" placeholder="<?php esc_attr_e( 'Leave blank to use defaults', 'wp-easycart-pro' ); ?>" style="width:100%;" id="ec_option_stripe_pay_later_minimum" value="<?php echo esc_attr( get_option( 'ec_option_stripe_pay_later_minimum' ) ); ?>" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" />
						<div class="wp-easycart-admin-icons-container" style="top:-2px;">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
								<div class="dashicons-before dashicons-yes-alt wp_easycart_toggle_saved" style="display: none;"></div>
							</div>
			...
			<div id="stripe_wallet_payments">
				<h3 style="float:left; width:100%; margin:25px 0 10px; border-bottom:1px solid #CCC; padding:0 0 5px;"><?php esc_attr_e( 'Wallet Payments', 'wp-easycart-pro' ); ?></h3>
				<div id="stripe_use_applepay" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show" style="padding:0px !important;">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Apple Pay and Google Pay', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_enable_apple_pay" id="ec_option_stripe_enable_apple_pay" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_enable_apple_pay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_enable_apple_pay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
				...
				<div id="stripe_wallet_first" class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important; font-size:12px;<?php if( ! get_option( 'ec_option_stripe_enable_apple_pay' ) ){ echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php esc_attr_e( 'Enable Apple Pay and Google Pay on Cart Entry', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_disable_wallet_first" id="ec_option_stripe_disable_wallet_first" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_disable_wallet_first' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Enable Wallet Entry Cart Page', 'wp-easycart-pro' ); ?></option>
							<option value="1" <?php if ( get_option( 'ec_option_stripe_disable_wallet_first' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disable Wallet Payments Until Payment Page', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
				...
				<div id="stripe_use_alipay" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="CNY,AUD,CAD,EUR,GBP,HKD,JPY,SGD,MYR,NZD,USD" data-countries="AU,AT,BE,BG,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,HU,IE,IT,JP,LV,LI,LT,LU,MY,LT,NL,NZ,NO,PT,RO,SG,SK,SI,ES,SE,CH,GB,US" data-country-currency='{"AU": ["AUD","CYN"],"CA": ["CAD","CYN"],"AT": ["EUR","CYN"],"BE": ["EUR","CYN"],"BG": ["EUR","CYN"],"CY": ["EUR","CYN"],"CZ": ["EUR","CYN"],"DK": ["EUR","CYN"],"EE": ["EUR","CYN"],"FI": ["EUR","CYN"],"FR": ["EUR","CYN"],"DE": ["EUR","CYN"],"GR": ["EUR","CYN"],"IE": ["EUR","CYN"],"IT": ["EUR","CYN"],"LV": ["EUR","CYN"],"LT": ["EUR","CYN"],"LU": ["EUR","CYN"],"MT": ["EUR","CYN"],"NL": ["EUR","CYN"],"NO": ["EUR","CYN"],"PT": ["EUR","CYN"],"RO": ["EUR","CYN"],"SK": ["EUR","CYN"],"SI": ["EUR","CYN"],"ES": ["EUR","CYN"],"SE": ["EUR","CYN"],"CH": ["EUR","CYN"],"GB": ["GBP","CYN"],"HK": ["HKD","CYN"],"JP": ["JPY","CYN"],"MY": ["MYR","CYN"],"NZ": ["NZD","CYN"],"SG": ["SGD","CYN"],"US": ["USD","CYN"]}' style="padding:0px !important;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'CNY', 'AUD', 'CAD', 'EUR', 'GBP', 'HKD', 'JPY', 'SGD', 'MYR', 'NZD', 'USD' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'BG', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HU', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MY', 'LT', 'NL', 'NZ', 'NO', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					...
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_alipay" id="ec_option_stripe_alipay" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_alipay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_alipay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
				...
				<div id="stripe_use_grabpay" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="SGD,MYR" data-countries="MY,SG" data-country-currency='{"MY": ["MYR"],"SG": ["SGD"]}' style="padding:0px !important;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'SGD', 'MYR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'MY', 'SG' ) ) ) { echo ' display:none;'; } ?>">
					...
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_grabpay" id="ec_option_stripe_grabpay" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_grabpay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_grabpay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['grabpay_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'grabpay_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'grabpay_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				...
				<div id="stripe_use_wechatpay" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="CNY,AUD,CAD,EUR,GBP,HKD,JPY,SGD,USD,DKK,NOK,SEK,CHF" data-countries="AU,AT,BE,CA,DK,FI,FR,DE,HK,IE,IT,JP,LU,NL,NO,PT,SG,ES,SE,CH,GB,US" data-country-currency='{"AU": ["AUD","CYN"],"CA": ["CAD","CYN"],"AT": ["EUR","CYN"],"BE": ["EUR","CYN"],"DK": ["EUR","DKK","CYN"],"FI": ["EUR","CYN"],"FR": ["EUR","CYN"],"DE": ["EUR","CYN"],"IE": ["EUR","CYN"],"IT": ["EUR","CYN"],"LU": ["EUR","CYN"],"NL": ["EUR","CYN"],"NO": ["EUR","NOK","CYN"],"PT": ["EUR","CYN"],"ES": ["EUR","CYN"],"SE": ["EUR","SEK","CYN"],"CH": ["EUR","CHF","CYN"],"GB": ["GBP","CYN"],"HK": ["HKD","CYN"],"JP": ["JPY","CYN"],"SG": ["SGD","CYN"],"US": ["USD","CYN"]}' style="padding:0px !important;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'CNY', 'AUD', 'CAD', 'EUR', 'GBP', 'HKD', 'JPY', 'SGD', 'USD', 'DKK', 'NOK', 'SEK', 'CHF' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'CA', 'DK', 'FI', 'FR', 'DE', 'HK', 'IE', 'IT', 'JP', 'LU', 'NL', 'NO', 'PT', 'SG', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					...
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_wechat" id="ec_option_stripe_wechat" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_wechat' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_wechat' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
				...
				<div id="stripe_use_link" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show" style="padding:0px !important;">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Link Payments', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_link" id="ec_option_stripe_link" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_link' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_link' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
			...
			<div id="stripe_bank_redirects" class="ec_admin_stripe_section" data-currencies="EUR,PLN,MYR" data-countries="AU,AT,BE,BG,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,HU,IE,IT,JP,LV,LI,LT,LU,MT,MX,MY,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,GB,US"<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR', 'PLN', 'MYR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'BG', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HU', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'MY', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' style="display:none;"'; } ?>>
				<h3 style="float:left; width:100%; margin:25px 0 10px; border-bottom:1px solid #CCC; padding:0 0 5px;"><?php esc_attr_e( 'Bank Redirects', 'wp-easycart-pro' ); ?></h3>
				<div id="stripe_use_bancontact" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="EUR" data-countries="AU,AT,BE,BG,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,HU,IS,IE,IT,JP,LV,LI,LT,LU,MT,MX,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,GB,US" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'BG', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HU', 'IS', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Bancontact (Common in Belgium)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_bancontact" id="ec_option_stripe_bancontact" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_bancontact' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_bancontact' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['bancontact_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'bancontact_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'bancontact_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				...
				<div id="stripe_use_blik" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="PLN" data-countries="AT,BE,BG,HR,CY,CZ,DK,EE,FI,FR,DE,GR,HU,IS,IE,IT,LV,LI,LT,LU,MT,NL,NO,PL,PT,RO,SK,SI,ES,SE" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'PLN' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AT', 'BE', 'BG', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GR', 'HU', 'IS', 'IE', 'IT', 'LV', 'LI', 'LT', 'LU', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SK', 'SI', 'ES', 'SE' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable BLIK (Common in Poland)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_blik" id="ec_option_stripe_blik" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_blik' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_blik' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['blik_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'blik_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'blik_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				</div>
				<div id="stripe_use_eps" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="EUR" data-countries="AU,AT,BE,BG,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,HU,IE,IT,JP,LV,LI,LT,LU,MT,MX,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,GB,US" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'BG', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HU', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable EPS (Common in Austria)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_eps" id="ec_option_stripe_eps" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_eps' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_eps' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['eps_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'eps_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'eps_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				</div>
				<div id="stripe_use_fpx" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="MYR" data-countries="MY" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'MYR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'MY' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable FPX (Common in Malaysia)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_fpx" id="ec_option_stripe_fpx" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_fpx' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_fpx' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['fpx_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'fpx_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'fpx_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				</div>
				<div id="stripe_use_giropay" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="EUR" data-countries="AU,AT,BE,BG,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,HG,IE,IT,JP,LV,LI,LT,LU,MT,MX,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,GB,US" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'BG', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HG', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable giropay (Common in Germany)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_giropay" id="ec_option_stripe_giropay" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_giropay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_giropay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['giropay_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'giropay_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'giropay_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				</div>
				<div id="stripe_use_ideal" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="EUR" data-countries="AU,AT,BE,BG,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,GH,IE,IT,JP,LV,LI,LT,LU,MT,MX,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,GB,US" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'BG', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'GH', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable iDEAL (the most popular payment method in the Netherlands)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_enable_ideal" id="ec_option_stripe_enable_ideal" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_enable_ideal' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_enable_ideal' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['ideal_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'ideal_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'ideal_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				</div>
				<div id="stripe_use_p24" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="EUR,PLN" data-countries="AU,AT,BE,BG,CA,HR,CZ,DK,EE,FI,FR,DE,GI,GR,HK,HG,IE,IT,JP,LV,LI,LT,LU,MT,MX,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,GB,US" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR', 'PLN' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'BG', 'CA', 'HR', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HG', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Przelewy24 (Common in Poland)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_p24" id="ec_option_stripe_p24" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_p24' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_p24' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['p24_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'p24_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'p24_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				...
				<div id="stripe_use_sofort" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="EUR" data-countries="AU,AT,BE,BG,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,GH,IE,IT,JP,LV,LI,LT,LU,MT,MX,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,GB,US" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'BG', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'GH', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Sofort (Common in Europe)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_sofort" id="ec_option_stripe_sofort" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_sofort' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_sofort' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['sofort_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'sofort_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'sofort_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
			...
			<div id="stripe_bank_debits" class="ec_admin_stripe_section" data-currencies="GBP,AUD,EUR" data-countries="GB,AU,AT,BE,GB,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,HG,IE,IT,JP,LV,LI,LT,LU,MT,MX,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,US"<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'GBP', 'AUD', 'EUR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'GB', 'AU', 'AT', 'BE', 'GB', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HG', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'US' ) ) ) { echo ' style="display:none;"'; } ?>>
				<h3 style="float:left; width:100%; margin:25px 0 10px; border-bottom:1px solid #CCC; padding:0 0 5px;"><?php esc_attr_e( 'Bank Debits', 'wp-easycart-pro' ); ?></h3>
				<div id="stripe_use_bacs" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="GBP" data-countries="GB" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'GBP' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'GB' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Bacs Direct Debit in the UK', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_bacs" id="ec_option_stripe_bacs" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_bacs' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_bacs' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['bacs_debit_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'bacs_debit_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'bacs_debit_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				...
				<div id="stripe_use_becs" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="AUD" data-countries="AU" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'AUD' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable BECS Direct Debit in Australia', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_becs" id="ec_option_stripe_becs" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_becs' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_becs' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['au_becs_debit_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'au_becs_debit_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'au_becs_debit_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				</div>
				<div id="stripe_use_sepa" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="EUR" data-countries="AU,AT,BE,GB,CA,HR,CY,CZ,DK,EE,FI,FR,DE,GI,GR,HK,HG,IE,IT,JP,LV,LI,LT,LU,MT,MX,NL,NZ,NO,PL,PT,RO,SG,SK,SI,ES,SE,CH,GB,US" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'EUR' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'AU', 'AT', 'BE', 'GB', 'CA', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HG', 'IE', 'IT', 'JP', 'LV', 'LI', 'LT', 'LU', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH', 'GB', 'US' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable SEPA Direct Debit (Europe)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_sepa" id="ec_option_stripe_sepa" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_sepa' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_sepa' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['sepa_debit_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'sepa_debit_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'sepa_debit_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
			...
			<div id="stripe_realtime_payments" class="ec_admin_stripe_section" data-currencies="BRL,SGD,THB" data-countries="BR,SG,TH"<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'BRL', 'SGD', 'THB' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'BR', 'SG', 'TH' ) ) ) { echo ' style="display:none;"'; } ?>>
				<h3 style="float:left; width:100%; margin:25px 0 10px; border-bottom:1px solid #CCC; padding:0 0 5px;"><?php esc_attr_e( 'Real Time Payments', 'wp-easycart-pro' ); ?></h3>
				<div id="stripe_use_pix" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="BRL" data-countries="BR" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'BRL' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'BR' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Pix (Brazil)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_pix" id="ec_option_stripe_pix" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_pix' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_pix' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
				...
				<div id="stripe_use_paynow" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="SGD" data-countries="SG" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'SGD' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'SG' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable PayNow (Singapore)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_paynow" id="ec_option_stripe_paynow" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_paynow' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_paynow' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['paynow_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'paynow_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'paynow_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				...
				<div id="stripe_use_promptpay" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="THB" data-countries="TH" style="padding:0px !important; font-size:12px;<?php if ( ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'THB' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'TH' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable PromptPay (Thailand)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_promptpay" id="ec_option_stripe_promptpay" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_promptpay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_promptpay' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['promptpay_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'promptpay_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'promptpay_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
			...
			<div id="stripe_realtime_payments" class="ec_admin_stripe_section" data-currencies="" data-countries="" data-currencies-future="BRL,JPY,MXN" data-countries-future="BR,JP,MX"<?php if ( true || ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'BRL', 'JPY', 'MXN' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'BR', 'JP', 'MX' ) ) ) { echo ' style="display:none;"'; } ?>>
				<h3 style="float:left; width:100%; margin:25px 0 10px; border-bottom:1px solid #CCC; padding:0 0 5px;"><?php esc_attr_e( 'Vouchers', 'wp-easycart-pro' ); ?></h3>
				<div id="stripe_use_boleto" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="" data-countries="" data-currencies-future="BRL" data-countries-future="BR" style="padding:0px !important; font-size:12px;<?php if ( true || ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'BRL' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'BR' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Boleto (Brazil)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_boleto" id="ec_option_stripe_boleto" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_boleto' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_boleto' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['boleto_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'boleto_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'boleto_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				...
				<div id="stripe_use_konbini" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="" data-countries="" data-currencies-future="JPY" data-countries-future="JP" style="padding:0px !important; font-size:12px;<?php if ( true || ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'JPY' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'JP' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable Konbini (Japan)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_konbini" id="ec_option_stripe_konbini" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_konbini' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_konbini' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['konbini_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'konbini_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'konbini_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
				...
				<div id="stripe_use_oxxo" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show ec_admin_stripe_settings_row" data-currencies="" data-countries="" data-currencies-future="MXN" data-countries-future="MX" style="padding:0px !important; font-size:12px;<?php if ( true || ! in_array( get_option( 'ec_option_stripe_currency' ), array( 'MXN' ) ) || ! in_array( get_option( 'ec_option_stripe_company_country' ), array( 'MX' ) ) ) { echo ' display:none;'; } ?>">
					<label style="float:left; width:100%;"><?php echo wp_easycart_escape_html( apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:0px;"></span>' ) ); ?><?php esc_attr_e( 'Enable OXXO (Mexico)', 'wp-easycart-pro' ); ?></label>
					<fieldset class="wp-easycart-admin-field-container">
						<select name="ec_option_stripe_oxxo" id="ec_option_stripe_oxxo" onchange="ec_admin_update_stripe_connect_option( jQuery( this ) );" class="wp-easycart-admin-field">
							<option value="1" <?php if ( get_option( 'ec_option_stripe_oxxo' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Yes Enable', 'wp-easycart-pro' ); ?></option>
							<option value="0" <?php if ( ! get_option( 'ec_option_stripe_oxxo' ) ) { echo ' selected'; } ?>><?php esc_attr_e( 'Disabled', 'wp-easycart-pro' ); ?></option>
						</select>
						<div class="wp-easycart-admin-icons-container">
							<div class="wp-easycart-admin-icon-close">
								<div class="wp-easycart-admin-dual-ring wp_easycart_toggle_saving" style="display: none;"></div>
					...
					<?php if ( $default_currency && 'missing' == $supported_payment_methods['oxxo_payments'] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be available, enabled, or active in your Stripe account, activating may cause problems. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'inactive' == $supported_payment_methods[ 'oxxo_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This payment type may not be enabled or active in your Stripe account. Please test if you choose to enable this feature.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } else if ( 'pending' == $supported_payment_methods[ 'oxxo_payments' ] ) { ?>
					<div class="ec_method_deactivated">
						<span class="ec_status_label" style="line-height:1.2em;"><?php esc_attr_e( 'This method is currently pending in your account and is not ready for use.', 'wp-easycart-pro' ); ?></span>
					</div>
					<?php } ?>
		...
		<div class="ec_admin_toggles_wrap">
			<div class="ec_admin_toggle">
				<span><?php _e( 'Enable Live', 'wp-easycart-pro' ); ?>:</span>
				<?php if( get_option( 'ec_option_stripe_connect_production_access_token' ) == '' ){ ?>
				<a href="https://connect.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=production&wp_easycart_nonce=' . wp_create_nonce( 'wp-easycart-stripe' ) ); ?>&env=production">
				<span></span>
				<?php }?>
			...
			<div class="ec_admin_toggle">
				<span><?php _e( 'Enable Sandbox', 'wp-easycart-pro' ); ?>:</span>
				<?php if( get_option( 'ec_option_stripe_connect_sandbox_access_token' ) == '' ){ ?>
				<a href="https://connect.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=sandbox&wp_easycart_nonce=' . wp_create_nonce( 'wp-easycart-stripe' ) ); ?>&env=sandbox">
				<span></span>
				<?php }?>
				<label class="ec_admin_switch">
		...
		<div class="ec_admin_webhook">
			...
			<div class="dashicons dashicons-yes-alt"></div> <?php _e( 'It looks like you have already added the Webhook URL to your Stripe account, but if you ever need the information again: ', 'wp-easycart-pro' ); ?> 
			<a href="http://docs.wpeasycart.com/wp-easycart-administrative-console-guide/?section=stripe" target="_blank"><?php _e( 'Click Here to Learn More', 'wp-easycart-pro' ); ?></a>
			<?php }else{ ?>
			<div class="dashicons dashicons-warning"></div> <strong><?php _e( 'To Do', 'wp-easycart-pro' ); ?>:</strong> <?php _e( 'You must add the Webhook URL to your Stripe account for best results.', 'wp-easycart-pro' ); ?> 
			<a href="http://docs.wpeasycart.com/wp-easycart-administrative-console-guide/?section=stripe" target="_blank"><?php _e( 'Click Here to Learn More', 'wp-easycart-pro' ); ?></a>
			<?php }?>
		</div>

		<div class="ec_admin_webhook">
			<strong><?php _e( 'Webhook URL', 'wp-easycart-pro' ); ?>:</strong> 
			<a href="#" onclick="ec_admin_copy_stripe_webhook( ); return false;"><?php _e( 'Copy Webhook to Clipboard', 'wp-easycart-pro' ); ?></a>
		</div>
		<div class="ec_admin_webhook_copy" id="stripe_webhook_copied" style="display:none;"><?php _e( 'Webhook URL has been copied to your clipboard!', 'wp-easycart-pro' ); ?></div>
		<?php }?>
	</div>
</div>