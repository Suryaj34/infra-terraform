...
class ec_stripe extends ec_gateway{
	...
	*****************************************/
	...
	////////////////////////////////////////////////
	public function insert_price( $product ){
		$data = $this->get_insert_price_data( $product );
	...
	public function confirm_payment_intent( $id ){
		$data = $this->get_confirm_payment_intent_data( $id );
	...
	////////////////////////////////////////////////
	private function get_insert_price_data( $product ) {
		$currency = get_option( 'ec_option_stripe_currency' );
		$gateway_data = array(
			'currency' => $currency,
	...
	private function get_confirm_payment_intent_data( $payment_intent_id ) {
		return array();
	}
