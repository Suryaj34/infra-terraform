...
if ( !class_exists('WPECPluginUpdateChecker_2_0') ):
 ...
 * @access public
 */
class WPECPluginUpdateChecker_2_0 {
	...
	public function requestInfo($queryArgs = array()){
		...
		if ( !is_wp_error($result) && isset($result['response']['code']) && ($result['response']['code'] == 200) && !empty($result['body']) ){
			...
			if ( isset( $pluginInfo ) && is_object( $pluginInfo ) ) {
				$pluginInfo->filename = $this->pluginFile;
				$pluginInfo->slug = $this->slug;
			} else {
				$pluginInfo = (object) array(
					'name' => 'WP EasyCart Professional Admin',
					'slug' => 'wp-easycart-pro',
					'download_url' => 'https://connect.wpeasycart.com/downloads/wp-easycart-admin-pro-download.php',
					'version' => '',
					'author' => 'Level Four Development, llc',
					'author_homepage' => 'https://wpeasycart.com',
					'homepage' => 'https://wpeasycart.com',
					'siteurl' => get_home_url(),
					'sections' => (object) array(
						'description' => 'There is currently new updates for WP EasyCart, however, you have not activated your license. Please go to the WP EasyCart -> Registration panel to activate your license before updating.',
					),
				);
			}
...
PucFactory::addVersion('PluginUpdateChecker', 'WPECPluginUpdateChecker_2_0', '2.0');
PucFactory::addVersion('PluginUpdate', 'PluginUpdate_2_0', '2.0');
PucFactory::addVersion('PluginInfo', 'PluginInfo_2_0', '2.0');
PucFactory::addVersion('PucGitHubChecker', 'WPECPucGitHubChecker_2_0', '2.0');
...
if ( !class_exists('PluginUpdateChecker') ) {
	class PluginUpdateChecker extends WPECPluginUpdateChecker_2_0 { }
}
