 ...
 * About Us Section
 * 
 * slug: ecommerce-gadget-store/about-us-section
 * title: About Us Section
 * categories: ecommerce-gadget-store
 */

    return array(
        'title'      =>__( 'About Us Section', 'ecommerce-gadget-store' ),
        'categories' => array( 'ecommerce-gadget-store' ),
        'content'    => '<!-- wp:spacer {"height":"80px"} -->
        <div style="height:80px" aria-hidden="true" class="wp-block-spacer"></div>
        <!-- /wp:spacer -->

        <!-- wp:group {"className":"about-us-section","backgroundColor":"secbackground","layout":{"type":"constrained","contentSize":"80%"}} -->
        <div id="aboutus" class="wp-block-group about-us-section has-secbackground-background-color has-background"><!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|60"}}}} -->
        ...
        <p class="has-accent-color has-text-color has-link-color has-poppins-font-family has-medium-font-size" style="font-style:normal;font-weight:600">'. esc_html__('About Us','ecommerce-gadget-store').'</p>
        <!-- /wp:paragraph -->

        <!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"800","fontSize":"28px","textTransform":"capitalize"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"poppins"} -->
        <h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-poppins-font-family" style="font-size:28px;font-style:normal;font-weight:800;text-transform:capitalize">'. esc_html__('We want to give you the best services','ecommerce-gadget-store').'</h2>
        <!-- /wp:heading -->
        ...
        <!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"19px","textTransform":"capitalize"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"textColor":"primary","fontFamily":"poppins"} -->
        <h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-poppins-font-family" style="margin-top:var(--wp--preset--spacing--40);font-size:19px;font-style:normal;font-weight:700;text-transform:capitalize">'. esc_html__('Guaranteed Results','ecommerce-gadget-store').'</h2>
        <!-- /wp:heading -->
        ...
        <p class="has-primary-color has-text-color has-link-color has-rubik-font-family has-extra-small-font-size" style="font-style:normal;font-weight:400;line-height:1.5">'. esc_html__('Lorem Ipsum is simply dummy text of the printing and typesetting industry.','ecommerce-gadget-store').'</p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column -->
        ...
        <!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"19px","textTransform":"capitalize"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"textColor":"primary","fontFamily":"poppins"} -->
        <h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-poppins-font-family" style="margin-top:var(--wp--preset--spacing--40);font-size:19px;font-style:normal;font-weight:700;text-transform:capitalize">'. esc_html__('Quality Services','ecommerce-gadget-store').'</h2>
        <!-- /wp:heading -->
