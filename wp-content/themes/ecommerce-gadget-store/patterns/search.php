 ...
 * Search Section
 * 
 * slug: ecommerce-gadget-store/search-page
 * title: Search Page
 * categories: ecommerce-gadget-store
 */

return array(
    'title'      =>__( 'Search Page', 'ecommerce-gadget-store' ),
...
<h2 class="wp-block-heading has-text-align-center"> '. esc_html__('No results found','ecommerce-gadget-store').'</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">   '. esc_html__('We could not find any posts matching your search. Try different keywords.','ecommerce-gadget-store').'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"ecommerce-gadget-store","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
